...
// and then downloaded to the FPGA board using Rhs2000EvalBoardUsb3::uploadCommandList.

// Constructor.  Set RHS2116 register variables to default values.
Rhs2000RegistersUsb3::Rhs2000RegistersUsb3(double sampleRate, StimStepSize stimStep_)
{
    stimStep = stimStep_;
...
// (This function does not change the sampling rate of the FPGA; for this, use Rhs2000EvalBoardUsb3::setSampleRate.)
void Rhs2000RegistersUsb3::defineSampleRate(double newSampleRate)
{
...
void Rhs2000RegistersUsb3::setDigOutLow(DigOut pin)
{
    switch (pin) {
    case(DigOut1):
        digOut1 = 0;
...
void Rhs2000RegistersUsb3::setDigOutHigh(DigOut pin)
{
    switch (pin) {
    case(DigOut1) :
        digOut1 = 1;
...
void Rhs2000RegistersUsb3::setDigOutHiZ(DigOut pin)
{
    switch (pin) {
    case(DigOut1) :
        digOut1 = 0;
...
void Rhs2000RegistersUsb3::enableDsp(bool enabled)
{
    dspEn = (enabled ? 1 : 0);
}
...
double Rhs2000RegistersUsb3::setDspCutoffFreq(double newDspCutoffFreq)
{
    int n;
...
double Rhs2000RegistersUsb3::getDspCutoffFreq() const
{
    double x;
    const double Pi = 2 * acos(0.0);
...
void Rhs2000RegistersUsb3::enableZcheck(bool enabled)
{
    zcheckEn = (enabled ? 1 : 0);
}

// Power up or down impedance checking DAC
void Rhs2000RegistersUsb3::setZcheckDacPower(bool enabled)
{
...
void Rhs2000RegistersUsb3::setZcheckScale(ZcheckCs scale)
{
    switch (scale) {
    case ZcheckCs100fF:
...
int Rhs2000RegistersUsb3::setZcheckChannel(int channel)
{
...
void Rhs2000RegistersUsb3::setAmpPowered(int channel, bool powered)
{
...
void Rhs2000RegistersUsb3::powerUpAllAmps()
{
...
void Rhs2000RegistersUsb3::powerDownAllAmps()
{
    for (int channel = 0; channel < 16; ++channel) {
        ampPwr[channel] = 0;
    }
...
void Rhs2000RegistersUsb3::setDCAmpPowered(int channel, bool powered)
{
    if (channel >= 0 && channel < 16) {
...
void Rhs2000RegistersUsb3::powerUpAllDCAmps()
{
    for (int channel = 0; channel < 16; ++channel) {
        dcAmpPwr[channel] = 1;
    }
...
void Rhs2000RegistersUsb3::powerDownAllDCAmps()
{
    for (int channel = 0; channel < 16; ++channel) {
        dcAmpPwr[channel] = 0;
    }
...
void Rhs2000RegistersUsb3::setStimEnable(bool enable)
{
    if (enable) {
        stimEnableA = 0xaaaa;
        stimEnableB = 0x00ff;
...
int Rhs2000RegistersUsb3::getRegisterValue(int reg)
{
    int regout;
...
int Rhs2000RegistersUsb3::vectorToWord(vector<int> &v)
{
    int word = 0;
...
double Rhs2000RegistersUsb3::rH1FromUpperBandwidth(double upperBandwidth) const
{
...
// bandwidth value (in Hz).
double Rhs2000RegistersUsb3::rH2FromUpperBandwidth(double upperBandwidth) const
{
    double log10f = log10(upperBandwidth);
...
// bandwidth value (in Hz).
double Rhs2000RegistersUsb3::rLFromLowerBandwidth(double lowerBandwidth) const
{
...
double Rhs2000RegistersUsb3::upperBandwidthFromRH1(double rH1) const
{
    double a, b, c;
...
double Rhs2000RegistersUsb3::upperBandwidthFromRH2(double rH2) const
{
    double a, b, c;
...
double Rhs2000RegistersUsb3::lowerBandwidthFromRL(double rL) const
{
    double a, b, c;
...
double Rhs2000RegistersUsb3::setUpperBandwidth(double upperBandwidth)
{
    ...
    /*
    cout << endl;
    cout << "Rhs2000RegistersUsb3::setUpperBandwidth" << endl;
...
double Rhs2000RegistersUsb3::setLowerBandwidth(double lowerBandwidth, int select)
{
    ...
    cout << endl;
    cout << fixed << setprecision(1);
    cout << "Rhs2000RegistersUsb3::setLowerBandwidth" << endl;
...
void Rhs2000RegistersUsb3::setStimStepSize(StimStepSize step)
{
    switch (step) {
...
double Rhs2000RegistersUsb3::stimStepSizeToDouble(StimStepSize step)
{
    switch (step) {
    case StimStepSize10nA:
        return 10.0e-9;
...
// for a channel (0-15).
int Rhs2000RegistersUsb3::setPosStimMagnitude(int channel, int magnitude, int trim)
{
    if (channel < 0 || channel > 15) {
        cerr << "Error in Rhs2000RegistersUsb3::setPosStimMagnitude: channel out of range." << endl;
        return -1;
    }
    if (magnitude < 0 || magnitude > 255) {
        cerr << "Error in Rhs2000RegistersUsb3::setPosStimMagnitude: magnitude out of range." << endl;
        return -1;
    }
    if (trim < -128 || trim > 127) {
        cerr << "Error in Rhs2000RegistersUsb3::setPosStimMagnitude: trim out of range." << endl;
        return -1;
    }
...
// for a channel (0-15).
int Rhs2000RegistersUsb3::setNegStimMagnitude(int channel, int magnitude, int trim)
{
    if (channel < 0 || channel > 15) {
        cerr << "Error in Rhs2000RegistersUsb3::setNegStimMagnitude: channel out of range." << endl;
        return -1;
    }
    if (magnitude < 0 || magnitude > 255) {
        cerr << "Error in Rhs2000RegistersUsb3::setNegStimMagnitude: magnitude out of range." << endl;
        return -1;
    }
    if (trim < -128 || trim > 127) {
        cerr << "Error in Rhs2000RegistersUsb3::setNegStimMagnitude: trim out of range." << endl;
        return -1;
    }
...
void Rhs2000RegistersUsb3::setChargeRecoveryCurrentLimit(ChargeRecoveryCurrentLimit limit)
{
    switch (limit) {
...
double Rhs2000RegistersUsb3::chargeRecoveryCurrentLimitToDouble(ChargeRecoveryCurrentLimit limit)
{
    switch (limit) {
    case CurrentLimit1nA:
        return 1.0e-9;
...
double Rhs2000RegistersUsb3::setChargeRecoveryTargetVoltage(double vTarget)
{
...
unsigned int Rhs2000RegistersUsb3::createRhs2000Command(Rhs2000CommandType commandType)
{
    switch (commandType) {
    ...
    case Rhs2000CommandComplianceReset:
        ...
        break;
    default:
        cerr << "Error in Rhs2000RegistersUsb3::createRhs2000Command: " <<
...
unsigned int Rhs2000RegistersUsb3::createRhs2000Command(Rhs2000CommandType commandType, unsigned int arg1)
{
    switch (commandType) {
...
unsigned int Rhs2000RegistersUsb3::createRhs2000Command(Rhs2000CommandType commandType, unsigned int arg1, unsigned int arg2)
{
    switch (commandType) {
...
// Return a 32-bit MOSI command (WRITE)
unsigned int Rhs2000RegistersUsb3::createRhs2000Command(Rhs2000CommandType commandType, unsigned int arg1, unsigned int arg2, unsigned int uFlag, unsigned int mFlag)
{
    switch (commandType) {
    case Rhs2000CommandRegWrite:
        if (arg1 > 255) {
...
int Rhs2000RegistersUsb3::createCommandListRegisterConfig(vector<unsigned int> &commandList, bool updateStimParams)
{
...
int Rhs2000RegistersUsb3::createCommandListRegisterRead(vector<unsigned int> &commandList)
{
    commandList.clear();    // if command list already exists, erase it and start a new one
...
// Returns the length of the command list.
int Rhs2000RegistersUsb3::createCommandListZcheckDac(vector<unsigned int> &commandList, double frequency, double amplitude)
{
    int i, period, value;
    double t;
    const double Pi = 2 * acos(0.0);
    ...
    if (amplitude < 0.0 || amplitude > 128.0) {
        cerr << "Error in Rhs2000RegistersUsb3::createCommandListZcheckDac: Amplitude out of range." << endl;
        return -1;
    }
    if (frequency < 0.0) {
        cerr << "Error in Rhs2000RegistersUsb3::createCommandListZcheckDac: Negative frequency not allowed." << endl;
        return -1;
    }
    else if (frequency > sampleRate / 4.0) {
        cerr << "Error in Rhs2000RegistersUsb3::createCommandListZcheckDac: " <<
    ...
    if (frequency == 0.0) {
        ...
        if (period > MaxCommandLength) {
            cerr << "Error in Rhs2000RegistersUsb3::createCommandListZcheckDac: Frequency too low." << endl;
            return -1;
        }
        else {
            t = 0.0;
...
int Rhs2000RegistersUsb3::createCommandListDummy(vector <unsigned int> &commandList, int n)
{
    commandList.clear();
...
// Returns the length of the command list (which should be n).
int Rhs2000RegistersUsb3::createCommandListDummy(vector <unsigned int> &commandList, int n, unsigned int cmd)
{
    commandList.clear();
...
int Rhs2000RegistersUsb3::createCommandListSingleRegisterConfig(vector<unsigned int> &commandList, int reg)
{
    commandList.clear();    // If command list already exists, erase it and start a new one.
...
// Returns the length of the command list (which should be 128).
int Rhs2000RegistersUsb3::createCommandListSetStimMagnitudes(vector<unsigned int> &commandList, int channel,
...
// Returns the length of the command list (which should be 128).
int Rhs2000RegistersUsb3::createCommandListConfigChargeRecovery(vector<unsigned int> &commandList,
