...
#ifndef __RHS2000EDITOR_H_2AD3C591__
#define __RHS2000EDITOR_H_2AD3C591__
...
namespace IntanStimulationController
{
	...
	/**
      ...
      User interface for the RHS2000 source module.
    ...
    class RHS2000Editor : public VisualizerEditor, public ComboBox::Listener, public AsyncUpdater

	{
	public:
        RHS2000Editor(GenericProcessor* parentNode, RHS2000Thread*, bool useDefaultParameterEditors);
        ~RHS2000Editor();
	...
	private:
        ...
        JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(RHS2000Editor);
	...
	{
	public:
        HeadstageOptionsInterface(RHS2000Thread*, RHS2000Editor*, int hsNum);
	...
	{
	public:
        BandwidthInterface(RHS2000Thread*, RHS2000Editor*);
		~BandwidthInterface();
	...
	{
	public:
        DSPInterface(RHS2000Thread*, RHS2000Editor*);
		~DSPInterface();
	...
	{
	public:
        SampleRateInterface(RHS2000Thread*, RHS2000Editor*);
		~SampleRateInterface();
	...
	{
	public:
        AudioInterface(RHS2000Thread*, RHS2000Editor*);
		~AudioInterface();
...
#endif  // __RHS2000EDITOR_H_2AD3C591__
